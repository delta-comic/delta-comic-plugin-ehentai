...
- 提供有关 _E-Hentai **/** EXHentai_ 的相关功能

## 声明

- 本项目使用[EhTagTranslation/Database](https://github.com/EhTagTranslation/Database)进行标签翻译  
- 根据许可，在此注明
- 许可链接<https://github.com/EhTagTranslation/Database/blob/master/LICENSE.md>
